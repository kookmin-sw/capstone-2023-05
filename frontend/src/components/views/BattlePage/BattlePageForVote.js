...
import TeamsOpinionsForVote from '../cardView/TeamsOpinionsForVote'
    ...
    <div className="flex flex-col h-screen">
      ...
      <div className='flex flex-1 my-auto'>
        ...
        <div className='flex w-2/3 h-full bg-background-color'>
          ...
          {/* timer */}
          <div id='adsTimer' className=' flex font-bold pt-aboveBest mr-9 w-11 text-gray-500'>1:00</div>
      ...
      <div className='absolute w-screen h-screen z-10 inset-0'>
        <TeamsOpinionsForVote/>
      </div>
    </div>
  );
};
