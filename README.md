...
- [Naruhodoo (나루호두)](#naruhodoo-나루호두)
  ...
  - [3. 문제 해결 :gem:](#3-문제-해결-gem)
      - [기대효과](#기대효과)
  - [4. 진행의 흐름 :arrows\_clockwise:](#4-진행의-흐름-arrows_clockwise)
...
라이브 방송에서 시청자들과 방송진행자가 모두 함께 모여 토론을 할 수 있는 플랫폼입니다.
...
플랫폼을 이용하여 대립되는 주제에 대한 방을 만들고 유저들은 그 토론 방에 참여하여 팀을 가르고 의견을 냅니다. 의견을 내는 과정에서 플랫폼 알고리즘에 의해 Best 의견을 선정이되고 이러한 의견과 수치를 화면에 띄워서 방송진행자와 유저들에게 보여줍니다.
...
4.  토론 준비 단계에서는 각 팀에 속한 시청자가 자신 의견을 올림과 동시에 지지하는 의견에 좋아요를 누릅니다
5.  준비 시간이 종료되면 가장 많은 투표 Top 3을 모두에게 공개하고, 호스트(방송인)이 공개된 의견을 바탕으로 방송을 진행합니다.
...
-   #### :key: 알고리즘 기반의 의견 선정
    ...
    5. 의견에 대한 Like 수를 숨겨서 편향을 억제합니다
    6. BEST 의견은 노출된 동안의 단위 시간당 좋아요 수 Top 3입니다
    ...
    8. 한 사람이 1 refresh cycle동안 Like를 누를 수 있는 횟수를 N회로 제한합니다.

-   #### :heart: 좋아요의 기능

    유저들은 공감하는 의견에 좋아요를 눌러서 집단의 의견을 최대한 하나로 수렴시켜 의견을 표출할 수 있습니다.

-   #### :speech_balloon: 팀 선택의 기능
...
>-   **Phase (단계)**: 게임의 진행단위를 의미합니다.
>    -   **Ready (배틀 대기 상태)**: 게임 시작 전 유저를 모으는 단계
>    -   **Vote (팀 선택 단계)**: 유저들이 원하는 팀을 선택하는 단계
>    -   **Preparation (토론 준비 단계)**: 토론 의견들을 준비하는 상태
>    -   **Discussion (토론 단계)**:   이전 단계에서 올라온 의견들 중에서 팀을 대표할 의견을 선정하는 단계
>    -   **Mid Result (중간 결과 단계)**:   라운드가 끝날 때마다 투표 결과를 알려주는 단계
>    -   **Final Result (최종 결과 단계)**:   최종 라운드에서 보여주는 결과 단계

* ### 의견 표출 및 선정 관련 용어 :key:
> -   **Best (베스트)**: 알고리즘에 의해 선정된 대표 의견들을 보여주는 UI
> -   **Ads (광고판)**: General로부터 랜덤으로 추출되어 Best의 후보가 되는 의견들을 보여주는 UI
> -   **General (일반)**: 조건 없이 유저들이 낸 의견들을 보여주는 UI
> -   **Opinion (의견)**: 유저가 내는 의견을 지칭한다
> -   **Refresh Rate (업데이트 간격)**: 업데이트가 되는 간격을 의미한다.
> -   **Refresh (업데이트)**: Ads와 Best가 Likes를 바탕으로 업데이트 되는 것

* ### 그 외 일반 용어 :bulb:
>-   **Host (방장)**: 토론을 주최한 사람
>-   **User (사용자)**: 토론에 참여한 사람
>-   **Round (라운드)**: 토론의 의견을 바탕으로 탑 3를 선정하여 결과를 보여주는 한 사이클
>-   **Vote (투표)**: 원하는 입장의 팀을 선택하는 단계. 선택하지 않은 유저는 팀이 랜덤으로 선택된다
>-   **Like (좋아요)**: 유저가 동감하는 의견에 동조하는 것
