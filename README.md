...
플랫폼을 이용하여 대립되는 주제에 대한 방을 만들고 유저들은 그 토론 방에 참여하여 팀을 가르고 의견을 냅니다. 의견을 내는 과정에서 플랫폼 프로세스에 의해 Best 의견을 선정이되고 이러한 의견과 수치를 화면에 띄워서 방송진행자와 유저들에게 보여줍니다.
...
>    -   **Ready (토 대기 상태)**: 게임 시작 전 유저를 모으는 단계
